" My custom color scheme (edited from iceberg)
...
if &background == 'light'
  ...
  hi LineNr ctermbg=NONE ctermfg=248 guibg=NONE guifg=#9fa7bd
  ...
  hi TabLineFill cterm=reverse ctermbg=244 ctermfg=251 gui=reverse guibg=#8b98b6 guifg=#cad0d
  ...
  hi Function ctermfg=204 guifg=#84a0c6
  ...
  hi PreProc ctermfg=208 guifg=#b4be82
  ...
  hi String ctermfg=150 guifg=#93b770
  ...
  hi Title ctermfg=204 gui=NONE guifg=#e2a478
