" My custom color scheme for spooktober
...
let g:colors_name = 'spooktober'

hi Normal ctermbg=NONE ctermfg=252 guibg=NONE guifg=#F6F7F8
...
hi CursorLine cterm=NONE ctermbg=235 ctermfg=NONE guibg=#2c303e guifg=NONE
...
hi Cursor ctermbg=252 ctermfg=234 guibg=NONE guifg=NONE
...
hi Directory ctermfg=109 guifg=#8a8ea8
...
hi Function ctermfg=204 guifg=#b3bd81
hi Identifier cterm=NONE ctermfg=109 guifg=#e7af88
hi Ignore ctermbg=NONE ctermfg=NONE guibg=NONE guifg=NONE
hi Include ctermfg=110 guifg=#8a8ea8
...
hi Operator ctermfg=110 guifg=#c57339
...
hi PreProc ctermfg=208 guifg=#ffffff
...
hi Special ctermfg=150 guifg=#a093c7 
...
hi Statement ctermfg=110 gui=NONE guifg=#bd93f9
...
hi StorageClass ctermfg=110 guifg=#ffc7e3
hi String ctermfg=150 guifg=#ADAFC2 
hi Structure ctermfg=110 guifg=#ffc7e3
...
hi Title ctermfg=204 gui=NONE guifg=#ffaf87
hi Todo ctermbg=NONE ctermfg=124 guibg=#45493e guifg=#b4be82
hi Type ctermfg=110 gui=NONE guifg=#b4be82
...
hi GitGutterAdd ctermbg=235 ctermfg=150 guibg=NONE guifg=#b4be82
hi GitGutterChange ctermbg=235 ctermfg=109 guibg=NONE guifg=#89b8c2
hi GitGutterChangeDelete ctermbg=235 ctermfg=109 guibg=NONE guifg=#89b8c2
hi GitGutterDelete ctermbg=235 ctermfg=203 guibg=NONE guifg=#e27878
hi gitmessengerEndOfBuffer ctermbg=235 ctermfg=239 guibg=NONE guifg=#444b71
hi gitmessengerPopupNormal ctermbg=235 ctermfg=252 guibg=NONE guifg=#c6c8d1
...
if has('nvim')
  ...
  let g:terminal_color_14 = '#E01035'
  let g:terminal_color_15 = '#d2d4de'
else
  let g:terminal_ansi_colors = ['#1e2132', '#e27878', '#b4be82', '#e2a478', '#84a0c6', '#a093c7', '#89b8c2', '#c6c8d1', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#ada0d3', '#E01035', '#d2d4de']
endif
